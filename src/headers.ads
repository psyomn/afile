...
package Headers is
   ...
   Zlib_No_Compression
     : constant Unsigned_64 := 16#78_01#;
   Zlib_Default_Compression
     : constant Unsigned_64 := 16#78_9C#;
   Zlib_Best_Compression
     : constant Unsigned_64 := 16#78_DA#;

   Dos_Executable
     : constant Unsigned_64 := 16#4D_5A#;
   --  Compressed with Lempel-Ziv-Welch algorithm
   Tar_Z_Lzw
     : constant Unsigned_64 := 16#1f_9d#;
   --  Compressed with LZH
   Tar_Z_Lzh
     : constant Unsigned_64 := 16#1f_0a#;
   Bz2
     : constant Unsigned_64 := 16#42_5A_68#;
   Webm
     : constant Unsigned_64 := 16#1A_45_Df_A3#;
   Psd
     : constant Unsigned_64 := 16#38_42_50_53#;
   Flif
     : constant Unsigned_64 := 16#46_4c_49_46#;
   Ogg
     : constant Unsigned_64 := 16#4F_67_67_53#;
   Rpm
     : constant Unsigned_64 := 16#ed_ab_ee_db#;
   Kindle_Updater
     : constant Unsigned_64 := 16#53_50_30_31#;
   Palm_Calendar_Archive
     : constant Unsigned_64 := 16#be_ba_fe_ca#;
   --  cafe babe! nice :)
   Palm_To_Do_Archive
     : constant Unsigned_64 := 16#00_01_42_44#;
   Palm_Calendar_Archive_2
     : constant Unsigned_64 := 16#00_01_44_54#;
   Palm_Data_File
     : constant Unsigned_64 := 16#00_01_00_00#;
   Ico
     : constant Unsigned_64 := 16#00_00_01_00#;
   Tiff_Little_Endian
     : constant Unsigned_64 := 16#49_49_2A_00#;
   Tiff_Little_Big_Endian
     : constant Unsigned_64 := 16#4D_4D_00_2A#;
   Gif_87a
     : constant Unsigned_64 := 16#47_49_46_38_37_61#;
   Gif_89a
     : constant Unsigned_64 := 16#47_49_46_38_39_61#;
   Rar_1_50
     : constant Unsigned_64 := 16#52_61_72_21_1a_07_00#;
   Ms_Office
     : constant Unsigned_64 := 16#d0_cf_11_e0_a1_b1_1a_e1#;
   Rar_5
     : constant Unsigned_64 := 16#52_61_72_21_1a_07_01_00#;
   Tar_Ustar_00
     : constant Unsigned_64 := 16#75_73_74_61_72_00_30_30#;
   Tar_Ustar
     : constant Unsigned_64 := 16#75_73_74_61_72_20_20_00#;
   Png
     : constant Unsigned_64 := 16#89_50_4e_47_0d_0a_1a_0a#;
   ...
   All_File_Signatures : constant Signatures
     := (
         ...
         (Magic_Number => Palm_Data_File,
          ...
          Offset       => 0,
          Description  =>
            new String'("palm desktop data file (ms access format)")),
